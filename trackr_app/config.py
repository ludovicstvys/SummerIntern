...
class Settings:
    ...
    smtp_server: str = _value("SMTP_SERVER", "smtp.gmail.com")
    smtp_port: int = int(_value("SMTP_PORT", "587"))
    smtp_user: str = _value("SMTP_USER")
    smtp_password: str = _value("SMTP_PASS_APP")
    ...
    def validate(self) -> None:
        ...
        if self.notion_client_id or self.notion_client_secret:
