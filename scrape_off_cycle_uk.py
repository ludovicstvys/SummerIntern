...
if __name__ == "__main__":
    ...
    if new_offers:
        print(f"{len(new_offers)} nouvelle(s) offre(s) off-cycle UK détectée(s), envoi email")
        send_email(new_offers, csv_file, "off-cycle internship(s) UK")
    else:
        print("Aucune nouvelle offre off-cycle UK détectée, email non envoyé")
