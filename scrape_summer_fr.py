...
TRACKR_PARAMS = {'region': 'France', 'industry': 'Finance', 'season': settings.season, 'type': 'summer-internships'}
DEFAULT_OUTPUT_FILE = 'processus_ouverts_fr_summer.csv'
...
if __name__ == '__main__':
    raise SystemExit(run_collector(TRACKR_PARAMS, os.getenv('OUTPUT_FILE', DEFAULT_OUTPUT_FILE), 'France summer-internships', None))
